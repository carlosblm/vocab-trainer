...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_id"],
            ["sources.id"],
            name=op.f("fk_entries_source_id_sources"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
        ...
        sa.UniqueConstraint(
            "user_id", "lemma", "lang", name=op.f("uq_entries_user_id")
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["entry_id"],
            ["entries.id"],
            name=op.f("fk_contexts_entry_id_entries"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_contexts")),
        sa.UniqueConstraint(
            "entry_id", "external_id", name=op.f("uq_contexts_entry_id")
        ),
    )
    op.create_index(
        op.f("ix_contexts_entry_id"), "contexts", ["entry_id"], unique=False
    )
